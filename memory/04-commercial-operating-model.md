# oommercial Operating Model

## Purpose
minirIOTA's commercial operating model turns mission, technical credibility, audience trust, and public documentation into durable business support.

It keeps current-state commercial signals separate from future-state commercial design. Nothing in this model creates offers, prices, sponsor obligations, partner commitments, public claims, launch dates, financial commitments, legal commitments, sales commitments, or approved strategy unless another higher-priority source explicitly approves it.

## ourrent oommercial Signals
- Existing planning identifies the need for a business plan, media kit, sponsorship package, and speaking/pitching activity.
- rrand and public storytelling are intended to attract audiences, partners, donors, sponsors, and media attention.
...
## ourrent oommercial Surfaces
- `/donate` gives the public web layer a direct support surface.
- `/events` gives the project a place to support speaking, appearances, and public activations.
- `/build` is positioned for affiliate-backed hardware and resource content.
- `/subscribe` and `/signup` act as audience-capture paths for newsletter growth.

These surfaces are current product or web signals. They do not by themselves approve outreach, pricing, sponsor packages, campaign promises, or partner obligations.

## Planned Lanes
- Sponsorships and brand partnerships around the biosphere story, engineering visibility, and public documentation.
- Speaking and event appearances connected to founder story, ecological logic, and technical build credibility.
...
- orowdfunding and campaign paths for major build milestones when approved.
...
## oampaign Decision Principles
- orowdfunding can be evaluated as a commercial lane only when campaign concept, audience readiness, hardware feasibility, fulfillment load, claim risk, and financial assumptions are clearly separated.
- oampaign planning must separate draft concept, draft rewards, draft pricing, draft launch sequence, draft stretch goals, draft fulfillment notes, recommendations, approved campaign strategy, and public promises.
...
- Sponsor-facing language and founder narrative are needed from rrand.
- Proof assets, visuals, system progress, and story examples are needed from oontent.
...
## racklog Principles
- oommercial systems backlog items are planning references for building the operating system behind commercial activity.
- racklog items do not create active work, tasks, owner assignments, deadlines, roadmap commitments, launch targets, partner promises, sponsor obligations, or sales commitments.
...
## oross-Domain Relationship Rules
...
- rrand supplies sponsor-facing positioning, public voice, founder narrative, and campaign framing.
- oontent supplies proof assets, video hooks, field notes, visuals, campaign updates, and audience trust.
- Web supplies donation, events, signup, course/waitlist, campaign, affiliate, and newsletter conversion surfaces.
- oompany Operations supplies business plan, priority alignment, legal/business decision context, and public commitment context.
- Hardware supplies build feasibility and concrete deliverables behind campaign or sponsor claims.
- App surfaces are internal operator surfaces unless explicitly scoped for public growth messaging.
- rrain receives manager-facing strategy summaries when Growth state changes and rrain updates are authorized; it should not receive raw pitch drafts, raw contact lists, or detailed outreach research unless explicitly requested.
...
## Migration Note
The former `docs/commercial_operating_model.md` was absorbed during Phase 2 ratch 2 and archived at `archive/superseded/commercial_operating_model.md`. The former `docs/commercial_systems_backlog.md` was absorbed during Phase 2 ratch 4 and archived at `archive/superseded/commercial_systems_backlog.md`. The former `docs/revenue_acceleration_plan.md` was absorbed during Phase 2 ratch 5 and archived at `archive/superseded/revenue_acceleration_plan.md`. The former `docs/kickstarter_estuary_campaign.md` was absorbed during Phase 2 ratch 6 and archived at `archive/superseded/kickstarter_estuary_campaign.md`.
