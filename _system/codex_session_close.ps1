...
if (Test-Path "$brainRoot\7. miniBIOTA_Growth\growth_brief.md") {
    Write-Host "Growth brief exists: $brainRoot\7. miniBIOTA_Growth\growth_brief.md"
} else {
...
Write-Host "- Confirm no Supabase, structured records, app behavior, public site behavior, Brain docs mirrors, or Brain growth brief changed unless approved."
